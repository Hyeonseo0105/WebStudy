...
public class FoodModel {
   ...
   */
  public void foodFindDetailData(HttpServletRequest request,
		  HttpServletResponse response)
  {
	  // JSON 전송 
  ...
  public String food_find_detail(HttpServletRequest request,
		  HttpServletResponse response)
  {
	  String fno=request.getParameter("fno");
	  FoodDAO dao=FoodDAO.newInstance();
  ...
  public String food_before(HttpServletRequest request,
		  HttpServletResponse response)
  {
	  String fno=request.getParameter("fno");
