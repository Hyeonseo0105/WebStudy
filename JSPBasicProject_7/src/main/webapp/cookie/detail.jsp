<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.sist.model.*,java.net.*"%>
	...
	<div class="container">
	  <div class="col-sm-7"> <%-- float:left --%>
	    <table class="table">
	      ...
	      <tr>
	        <td colspan="3" class="text-rigth"></td>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d2619d279eb9fac7ba95f6d01b516779&libraries=services"></script>
<script>
