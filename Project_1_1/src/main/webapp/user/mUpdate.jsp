...
<form id="login-form" method="post" action="../user/join_ok.do" name="frm">
  ...
  <div class="left">
    ...
    <input type="text" placeholder="새 비밀번호" name="pwd1">
    <input type="text" placeholder="새 비밀번호 확인" name="pwd2">
    <input type="text" placeholder="이름" name="name">
    <input type="email" placeholder="이메일" name="email1">
    ...
    <input type="text" placeholder="질문에 대한 답" id="a" name="hintA">
      <input type="submit" value="수정" id="joinBtn" name="joinBtn" style="cursor:pointer;float:left;margin-left:14%">
