...
<%
	...
	if(strPage==null)  // 처음실행 => 페이지 지정이 안된다 => 디폴트
			strPage="1";
	// 현재페이지 지정
...
<body>
	<center>
		<img id="main" src="https://images.pngnice.com/download/2007/QNA-PNG-Image.png" width="700px" height="200px">
	<table class="table_content" width=900>
			<tr>
				<td>
						 	...
						 	no에 해당하는 게시물을 출력요청
						 	  => 사용자 요청
						 	       ...
						 	       2) 화면변경 => <a> ==> GET
						 	          데이터를 받는 파일명?키=값&키=값...
						 	                              --구분자
						 	            => GET : URL주소에 노출 : id,pwd..(session(서버에 저장후))
						 	  => 클라이언트 / 서버
