<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// 1. 한글 = 디코딩을 한다 => 모든 jsp마다 내장 객체를 가지고 있다
...
<body>
	...
	3. 서버프로트콜 :<%=request.getProtocol() %><br>
	4. 정송받식 :<%=request.getMethod() %><br>
	5. 포트 버놓 :<%=request.getServerPort() %><br>
	6. ****요청 URL :<%=request.getRequestURL() %><br>
	7. ****요청 URI :<%=request.getRequestURI() %><br>
	8. ****ContextPath :<%=request.getContextPath() %>:루트폴더<br>
	9. 전송 값<br>
	   이름:<%=name %><br>
	   성별:<%=sex %><br>
	   전화:<%=tel %><br>
