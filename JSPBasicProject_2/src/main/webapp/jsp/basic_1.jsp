...
<%-- 
	  1. 동작
	       1) 요청 : http://localhost/JSPBasicProject_2/jsp/
	       ...
	       page : jsp파일에 대한 정보
	              사용법
	                <%@ page 속성=값 속성=값 속성=값 %>
	                         ...
	                         => XML형식으로 만들어져 있다
	                            ======
	                      문법이 어렵다 (1.대소문자를 구분,2.값을 설정할때 반드시 "")
	                         => info : 파일에 대한 설명
	                                   info="2023-12-05 임현서 수정"
	                                   info="게시판 수정파일"
	                         ...
	                         ***MAC / Window => 경로명 => 호환
	                         ...
	                         => inErrorPage : 종류별로 처리가 가능
	                              => 404 : 파일이 없는 경우
	                              => 500 : 자바 컴파일시 오류
	                              => 403 : 접근 거부 ==> Spring(Security) => 암호/복호 , 권한부
	                              => 400 : GET/POST => 전송방식
	                                       doGet / doPost
	                                         => service()
	                                         => @GetMapping
