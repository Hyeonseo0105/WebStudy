...
public class CategoryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.write("<html>");   // <html> : jsp에서
		out.write("<head>");
		// 외부 CSS => 파일에 공통 적용되는 CSS
		...
		out.write("<a href=CategoryServlet?cno=1 class=\"btn btn-sm btn-danger\">믿고 보는 맛집 리스트</a>&nbsp;");   // &nbsp : 공백
		out.write("<a href=CategoryServlet?cno=2 class=\"btn btn-sm btn-success\">지역별 맛집 리스트</a>&nbsp;");
		out.write("<a hrefCategoryServlet?cno=3 class=\"btn btn-sm btn-primary\">메뉴별 맛집 리스트</a>");
		out.write("</div>");		
		out.write("<div class=row>");
