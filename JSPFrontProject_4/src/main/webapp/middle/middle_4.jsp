...
window.onload=function(){
	const sawons=[
		{sabun:1,name:'임현서',dept:'개발부',loc:'서울',job:'과장'},
		{sabun:2,name:'황미애',dept:'영업부',loc:'경기',job:'대리'},
		{sabun:3,name:'김철',dept:'기획부',loc:'서울',job:'대리'},
		{sabun:4,name:'한송이',dept:'자재부',loc:'서울',job:'부장'},
		{sabun:5,name:'모진섭',dept:'총무부',loc:'부산',job:'사원'},
				 ]
	let html='';
	//for(SawonVO vo:list)
	/*
